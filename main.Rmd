...
- Most statistical methods are used to deliver estimates and predictions for different problems with the goal of using these results for decision-making (e.g. whether a patient should be treated, selecting a drug or its dosage). 
...
- This can lead to contradictory examples (e.g.  asymmetric "risk" of treating vs not treating a patient). Indeed, not all prediction errors are the "same" or have similar "impacts".
